...
const EN: Record<string, string> = {
  ...
  'trip.avg_speed_full': 'Avg speed',
  'trip.km_start': 'Start odometer',
  'trip.km_end': 'End odometer',
  'trip.batt_start': 'Start battery',
  'trip.batt_end': 'End battery',
  'trip.fuel_start': 'Start fuel',
  'trip.fuel_end': 'End fuel',
  'trip.view_compact': 'Compact',
  'trip.view_standard': 'Standard',
  'common.today': 'Today',
  'common.yesterday': 'Yesterday',
  'charge.title': 'Charging',
  'charge.power': 'Power',
  'charge.range': 'Range added',
  'charge.end_time': 'End time',
  'charge.empty': 'No charging sessions',
  'trip.cost': 'Cost',
...
const VI: Record<string, string> = {
  ...
  'trip.battery': 'Pin',
  'trip.fuel': 'Xăng',
  'trip.energy_used': 'Điện',
  'trip.fuel_used': 'Nhiên liệu',
  'trip.consumption': 'Tiêu thụ',
  'trip.avg_speed_full': 'Tốc độ TB',
  'trip.km_start': 'Km ban đầu',
  'trip.km_end': 'Km cuối cùng',
  'trip.batt_start': 'Pin ban đầu',
  'trip.batt_end': 'Pin cuối',
  'trip.fuel_start': 'Bình xăng đầu',
  'trip.fuel_end': 'Bình xăng cuối',
  'trip.view_compact': 'Gọn',
  'trip.view_standard': 'Tiêu chuẩn',
  'common.today': 'Hôm nay',
  'common.yesterday': 'Hôm qua',
  'charge.title': 'Sạc',
  'charge.power': 'Công suất',
  'charge.range': 'Quãng đường',
  'charge.end_time': 'Kết thúc',
  'charge.empty': 'Không có phiên sạc',
  'trip.cost': 'Chi phí',
  'trip.empty': 'Không có chuyến đi trong kỳ này',
  'cam.front': 'Trước',
  'cam.rear': 'Sau',
  'cam.left': 'Trái',
  'cam.right': 'Phải',
  ...
  'dev.presets': 'Hoặc chọn kiểu dáng',
